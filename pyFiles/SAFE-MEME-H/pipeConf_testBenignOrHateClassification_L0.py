...
from utilConf_L0forHateOrBenignDetectionTrain import CustomDatasetImg
...
def T5Trainer( args):
    ...
    if execution_mode in ['test_benignOrNOT_partialFT_singleCard', ]:
        ...
        # conf        
        # json_path = f'./resultsConf/testConf_fullFT_categoryCard_gDescGeneration_v1.json'
        # json_name = f'testConf_L0_usingpartialFTCategoryCardbasedGDesc_v1.json'

        json_path = f'./resultsConf/testConf_gDescGeneration_partialFT_categoryCard_v0.json'        
        json_name = f'testConf_L0_usingpartialFTCategoryCardbasedGDesc_v0.json' # palash
        ...
        data = { 'OCR': ocr_list, 'IMG_ID': path_list, 'LABEL': label_list, 'GENERAL_DESC': gdesc_list}
        test_df = pd.DataFrame(data)
