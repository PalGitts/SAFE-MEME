...
from util_L1forImpOrExpDetectionTrain import img_shape, CustomDatasetImg
...
def T5Trainer( args):
    ...
    if execution_mode in [
        ...
        if 'withGDesc' in execution_mode:
            ...
            json_L0 = f'./results/test_L0_usingpartialFTCategoryCardbasedGDesc_v2.json'
            json_name = f'test_L1_usingpartialFTCategoryCardbasedGDesc_v2.json'
        ...
        data = { 'OCR': ocr_list, 'PATH': path_list, 'LABEL': label_list, 'PRED_GENERAL_DESC': pred_gdesc_list}
