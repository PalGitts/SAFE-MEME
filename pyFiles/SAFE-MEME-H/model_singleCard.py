...
hidden_dim = 768
# category_card = torch.nn.Linear(hidden_dim, hidden_dim)
category_card = torch.load(f'./trained_cards/card_train_benignOrNOT_partialFT_singleCard_GENERAL').to(current_device)
# category_card = torch.load(f'./trained_cards/card_train_ExpOrImp_partialFT_singleCard_GENERAL').to(current_device)
