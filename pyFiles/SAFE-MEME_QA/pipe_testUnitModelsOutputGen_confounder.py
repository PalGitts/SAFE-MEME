...
'''
***** ATTENTION ****
The file 'pipe_testUnitModelsOutputGen' is used for inference of DatasetB-Confounder and NO training.
...
CUDA_VISIBLE_DEVICES=0 python3 pipe_testUnitModelsOutputGen_confounder.py         --execution_mode  testGDescGeneration        --img_type vit         --output_len 512         --full_FT YES         --model declare-lab/flan-alpaca-large         --user_msg rationale         --epoch 50         --lr 5e-5         --use_caption         --use_generate         --prompt_format QCM-E         --output_dir experiments         --final_eval
CUDA_VISIBLE_DEVICES=0 python3 pipe_testUnitModelsOutputGen_confounder.py         --execution_mode  testContextGeneration         --img_type vit         --output_len 256         --full_FT YES         --model declare-lab/flan-alpaca-large         --user_msg rationale         --epoch 50         --lr 5e-5         --use_caption         --use_generate         --prompt_format QCM-E         --output_dir experiments         --final_eval
CUDA_VISIBLE_DEVICES=0 python3 pipe_testUnitModelsOutputGen_confounder.py         --execution_mode  testGDescContextGeneration         --img_type vit         --output_len 256         --full_FT YES         --model declare-lab/flan-alpaca-large         --user_msg rationale         --epoch 50         --lr 5e-5         --use_caption         --use_generate         --prompt_format QCM-E         --output_dir experiments         --final_eval
CUDA_VISIBLE_DEVICES=0 python3 pipe_testUnitModelsOutputGen_confounder.py         --execution_mode  testGDescAllQAPairs         --img_type vit         --output_len 256         --full_FT YES         --model declare-lab/flan-alpaca-large         --user_msg rationale         --epoch 50         --lr 5e-5         --use_caption         --use_generate         --prompt_format QCM-E         --output_dir experiments         --final_eval
CUDA_VISIBLE_DEVICES=0 python3 pipe_testUnitModelsOutputGen_confounder.py         --execution_mode  testContextAllQAPairs         --img_type vit         --output_len 256         --full_FT YES         --model declare-lab/flan-alpaca-large         --user_msg rationale         --epoch 50         --lr 5e-5         --use_caption         --use_generate         --prompt_format QCM-E         --output_dir experiments         --final_eval
CUDA_VISIBLE_DEVICES=0 python3 pipe_testUnitModelsOutputGen_confounder.py         --execution_mode  testGDescContextAllQAPairs         --img_type vit         --output_len 256         --full_FT YES         --model declare-lab/flan-alpaca-large         --user_msg rationale         --epoch 50         --lr 5e-5         --use_caption         --use_generate         --prompt_format QCM-E         --output_dir experiments         --final_eval
CUDA_VISIBLE_DEVICES=0 python3 pipe_testUnitModelsOutputGen_confounder.py         --execution_mode  testContext2CLS         --img_type vit         --output_len 16         --full_FT YES         --model declare-lab/flan-alpaca-large         --user_msg rationale         --epoch 50         --lr 5e-5         --use_caption         --use_generate         --prompt_format QCM-E         --output_dir experiments         --final_eval
CUDA_VISIBLE_DEVICES=0 python3 pipe_testUnitModelsOutputGen_confounder.py         --execution_mode  testGDescContext2CLS         --img_type vit         --output_len 16         --full_FT YES         --model declare-lab/flan-alpaca-large         --user_msg rationale         --epoch 50         --lr 5e-5         --use_caption         --use_generate         --prompt_format QCM-E         --output_dir experiments         --final_eval
CUDA_VISIBLE_DEVICES=0 python3 pipe_testUnitModelsOutputGen_confounder.py         --execution_mode  testGDescAllQueryGen         --img_type vit         --output_len 128         --full_FT YES         --model declare-lab/flan-alpaca-large         --user_msg rationale         --epoch 50         --lr 5e-5         --use_caption         --use_generate         --prompt_format QCM-E         --output_dir experiments         --final_eval
CUDA_VISIBLE_DEVICES=0 python3 pipe_testUnitModelsOutputGen_confounder.py         --execution_mode  testGDescAllQueryGen_1Q1A         --img_type vit         --output_len 85         --full_FT YES         --model declare-lab/flan-alpaca-large         --user_msg rationale         --epoch 50         --lr 5e-5         --use_caption         --use_generate         --prompt_format QCM-E         --output_dir experiments         --final_eval
...
def parse_args():
    ...
    all_modes = [
        'testGDescGeneration', # i/p: OCR + Image => GDesc Generation
        ...
        # contextGen 2 Cls
        'testContext2CLS', # bs - 16
        'testGDescContext2CLS', # bs - 16

        # All QueryGen
        'testAllQueryGen', # bs -128
        'testGDescAllQueryGen', # bs - 128
        
        # 1Q1A
        'testAllQueryGen_1Q1A', # bs - 85 
        'testGDescAllQueryGen_1Q1A', # bs - 85
        # 'testGDescContextAllQueryGen_1Q1A' # bs - 85

        'testContextBasedAllQueryGen', # ol 30
        'testContextBasedAnswerGen_1Q1A', # ol 85
...
def T5Trainer( args):
    ...
    if execution_mode in ['testGDescGeneration']:
        ...
        json_name = 'testConfounder_memeGDescGeneration_output.json'
    ...
    if execution_mode in ['testContextGeneration']:
        ...
        json_name = 'testConfounder_memeContextGeneration_output.json'
    ...
    if execution_mode in ['testGDescContextGeneration']:
        ...
        json_name = 'testConfounder_memeGDescContextGeneration_output.json'
    ...
    if execution_mode in ['testGDescAllQAPairs']:
        ...
        json_name = 'testConfounder_memeGDescAllQAPairs_output.json'
    ...
    if execution_mode in ['testContextAllQAPairs']:
        ...
        json_name = 'testConfounder_memeContextAllQAPairs_output.json'
    ...
    if execution_mode in ['testGDescContextAllQAPairs']:
        ...
        json_name = 'testConfounder_memeGDescContextAllQAPairs_output.json'
    ...
    if execution_mode in ['testContext2CLS']: 
        ...
        json_name = 'testConfounder_memContextGen2Classification_output.json'
    ...
    if execution_mode in ['testGDescContext2CLS']: 
        ...
        json_name = 'testConfounder_memeGDescContextGen2Classification_output.json'
    ...
    if execution_mode in ['testAllQueryGen']:
        ...
        json_name = 'testConfounder_memeAllQueryGen_output.json'
    ...
    if execution_mode in ['testGDescAllQueryGen']:
        ...
        json_name = 'testConfounder_memeGDescAllQueryGen_output.json'
    ...
    if execution_mode in ['testAllQueryGen_1Q1A']: # bs - 85
        ...
        json_name = 'testConfounder_memeAllQueryGen_1Q1A_output.json'
    ...
    if execution_mode in ['testGDescAllQueryGen_1Q1A']: # bs - 85
        ...
        json_name = 'testConfounder_memeGDescAllQueryGen_1Q1A_output.json'

    
    if execution_mode in ['testContextBasedAllQueryGen']:
        chkp_id = 'checkpoint-43450/' 
    ...
    if args.img_type is not None:
        ...
        if args.img_type in ["vit", 'VIT']:
            ...
            image_features = torch.load("vision_features/VIT_confounder.pth")
            name_maps = json.load(open('vision_features/name_map_VIT_confounder.json'))
            print(f'image_model: vision_features/VIT_confounder.pth')
        
                
        #
        #   The following code loads the test data from DatasetB-Confounder or
        ...
        if 'testGDescAllQueryGen' in execution_mode:
            #
            generate_context_json = './results/testConfounder_memeGDescGeneration_output.json'
            ...
            for k, line in test_json.items():
                ...
                id_ = line['IMG_ID']
                ocr = line['OCR']
                all_lines.append( [pred_memeGDesc, ocr, label, id_])

            test_df = pd.DataFrame(all_lines, columns=['PRED_GDESC', 'OCR', 'LABEL', 'IMG_ID' ])


        # 1Q1A
        if execution_mode in ['testAllQueryGen_1Q1A']:
            #
            generate_context_json = './results/testConfounder_memeAllQueryGen_output.json'
            test_json = json.load( open(generate_context_json))
            ...
            for k, line in test_json.items():
                ...
                for q_idx, query in enumerate(pred_allQ):
                    ...
                    id_withSeq = str(q_idx) + '_' + id_
                    all_lines.append( [ query, ocr, label, id_, id_withSeq])

            test_df = pd.DataFrame(all_lines, columns=['PRED_QUERY',  'OCR', 'LABEL', 'IMG_ID', 'SEQ_ID' ])
            
        if execution_mode in ['testGDescAllQueryGen_1Q1A']:
            #
            generate_context_json = './results/testConfounder_memeGDescAllQueryGen_output.json'
            test_json = json.load( open(generate_context_json))
            ...
            for k, line in test_json.items():
                ...
                for q_idx, query in enumerate(pred_allQ):
                    ...
                    all_lines.append( [ query, pred_memeGDesc, ocr, label, id_])

            test_df = pd.DataFrame(all_lines, columns=['PRED_QUERY', 'PRED_GDESC', 'OCR', 'LABEL', 'IMG_ID' ])
    ...
    if args.prompt_format == "QCM-LE" or args.prompt_format == "QCM-E":
        ...
        while case_processed < total_cases:
            ...
            if tester.is_world_process_zero():
                ...
                # print(f'***************** temp_df: {temp_df.shape}')
                for idx, path_i in enumerate(temp_df['IMG_ID']):
                    
                    image_id = 'cnf_' + path_i.strip()
                    ...
                    if execution_mode in ['testGDescGeneration']:
                        id2info[image_id] = {
                            ...
                            'IMG_ID': temp_df.loc[0,'IMG_ID'].strip()
                        }
                    ...
                    if execution_mode in ['testGDescAllQAPairs']:
                        id2info[image_id] = {
                            'pred_memeGDescAllQAPairs': preds[idx], 
                            'LABEL': temp_df.loc[0,'LABEL'].strip().upper(),
                            'IMG_ID': temp_df.loc[0,'IMG_ID'].strip()
                        }
                    ...
                    if execution_mode in ['testContextAllQAPairs']:
                        id2info[image_id] = {
                            'pred_memeConextAllQAPairs': preds[idx], 
                            'LABEL': temp_df.loc[0,'LABEL'].strip().upper(),
                            'IMG_ID': temp_df.loc[0,'IMG_ID'].strip()
                        }
                    ...
                    if execution_mode in ['testGDescContextAllQAPairs']:
                        id2info[image_id] = {
                            'pred_memeGDescContextAllQAPairs': preds[idx], 
                            'LABEL': temp_df.loc[0,'LABEL'].strip().upper(),
                            'IMG_ID': temp_df.loc[0,'IMG_ID'].strip()
                        }
